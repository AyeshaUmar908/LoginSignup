...
public class TaskPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Task Post");
        mTaskPost = FirebaseDatabase.getInstance().getReference().child("Task Post");

        loginUsers = FirebaseDatabase.getInstance().getReference().child("user");
        ...
        loginUsers.child(mAuth.getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                userName = (String) dataSnapshot.child("email").getValue();
            }
            ...
            adapter = new ArrayAdapter<String>(TaskPostActivity.this, android.R.layout.simple_list_item_1, categories);
            ...
            task_posting_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (online.isChecked()) {
                        ...
                        i++;
                        Toast.makeText(TaskPostActivity.this, "Task Posted", Toast.LENGTH_SHORT).show();
                    } else {
